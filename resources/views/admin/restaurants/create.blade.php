...
{{-- Create new restaurant info --}}
    <div class="my-5 d-flex justify-content-between align-items-center">
        <h1 class="fs-2 pe-4">Registra il tuo ristorante!</h1>
    ...
    <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="mb-3 col-12 col-lg-5">
                ...
                <input type="number" class="form-control @error('vat_number') is-invalid @enderror" id="vat_number" name="vat_number" value="{{ old('vat_number') }}" required />
                @error('vat_number')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
